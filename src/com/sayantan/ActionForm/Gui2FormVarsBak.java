...
//	static String password = "aqf@123"; //dev
	...
	// Database connectivity
	static String m_DBDriver = "com.mysql.Driver";
	...
	public static void setM_DBDriver(String m_DBDriver) {
		Gui2FormVarsBak.m_DBDriver = m_DBDriver;
	}
	public static String getUrl() {
		return url;
	}
	public static void setUrl(String url) {
		Gui2FormVarsBak.url = url;
	}
	...
	public static void setUsername(String username) {
		Gui2FormVarsBak.username = username;
	}
	public static String getPassword() {
		return password;
	}
	public static void setPassword(String password) {
		Gui2FormVarsBak.password = password;
	}
	...
	public static void setPriceRatio(HashMap<Integer, String> priceRatio) {
		Gui2FormVarsBak.priceRatio = priceRatio;
	}
	...
	public static void setPriceCompare(HashMap<Integer, String> priceCompare) {
		Gui2FormVarsBak.priceCompare = priceCompare;
	}
